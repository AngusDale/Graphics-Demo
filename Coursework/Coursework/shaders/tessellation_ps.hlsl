        ...
        switch (type[i])
        {
            ...
            case 0:
                for (int j = 0; j < 6; j++)
                {
                    ...
                    {
                        // Has depth map data
                        if (!isInShadow(depthMapTexture[i][j], pTexCoord[i][j], input.lightViewPos[i][j], shadowMapBias))
                        {
            ...
            case 1:
                ...
                {
                    // Has depth map data
                    if (!isInShadow(depthMapTexture[i][0], pTexCoord[i][0], input.lightViewPos[i][0], shadowMapBias))
                    {
